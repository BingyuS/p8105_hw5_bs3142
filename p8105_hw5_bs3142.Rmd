...
**Description**
The dataset consists of homicide information in 50 large U.S. cities, each row is a case showing victim information (name, race, age, sex), murder data, location information (city, state, latitude, longitude), and disposition information of the case. There are a total of **`r nrow(cases_raw)`** cases.
